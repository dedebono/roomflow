      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Live <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-sky-400">Availability</span>
          </h2>
        ...
        <div className="space-y-8">
          {todaySchedules.map((venue, i) => (
            <motion.div
              ...
              className="bg-slate-900/40 rounded-3xl p-6 border border-slate-800"
            >
              ...
              <div className="relative grid grid-cols-1 sm:grid-cols-6 gap-2">
                {venue.slots.map((slot) => (
                  ...
                  >
                    <span className="text-xs text-slate-400 font-medium">{slot.time}</span>
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-500 text-sm flex items-center justify-center gap-2">
            <span className="h-2 w-2 rounded-full bg-blue-500" /> All times in UTC timezone
          </p>
        </div>
      </div>
    </section>
